...
<head>
    ...
    <script src="js/llenar_tabla_jquery.js"></script>
</head>
...
<body id="page1">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbar-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li role="presentation" class="active"><a href=""><span>PRODUCTOS</span></a></li>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 container">
        ...
        echo"
            <td><button class='btn btn-success' data-toggle='tooltip' data-placement='top' title='ELIMINAR PRODUCTO' onclick=mensaje('$row[7]','$row[0]','$row[9]') ><span class='glyphicon glyphicon-trash'></span></button></td>
            <td><button class='btn btn-success' data-toggle='tooltip' data-placement='top' title='VER REGISTRO' onclick=ShowDetalle('$row[0]') ><span class='glyphicon glyphicon-list-alt'></span></button> </td>
		</tr>";               } 
...
<script>
    ...
    function add_act(nombre, desc, marca, s, id, tipo, rem, prov) {
        ...
        document.getElementById('pre_pro').value = pre_pr;
    }
    ...
    function ShowDetalle(id) {
        window.open("php/VerAccion.php?idpro=" + id + "", 'IMPRIMIR', 'width=1100,height=500,scrollbars=SI');
    }
